    ...
    @if (isTenantAdmin()) {
      ...
      <main class="page ops-page dashboard-page hiring-manager-dashboard-page">
        ...
        @if (hiringManagerLoading()) {
          ...
          <section class="hiring-manager-dashboard-grid">
            <article class="ops-panel admin-panel hiring-dashboard-card full-span">
              <div class="panel-header">
                <div class="hiring-dashboard-panel-title">
            ...
            <article class="ops-panel admin-panel hiring-dashboard-card">
              <div class="panel-header">
                <div class="hiring-dashboard-panel-title">
            ...
            <article class="ops-panel admin-panel hiring-dashboard-card hiring-outcome-card full-span">
              <div class="panel-header">
                <div class="hiring-dashboard-panel-title">
              ...
              <div class="admin-metric-mini-grid">
                @for (item of dashboard.outcomeSplit; track item.status) {
                  <span class="hiring-outcome-tile">
                    <strong>{{ item.count }}</strong>
