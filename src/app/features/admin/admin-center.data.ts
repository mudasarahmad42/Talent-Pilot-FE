...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'notification-outbox', label: 'Email Outbox', icon: 'outbox' },
...
export const ADMIN_PAGES: AdminPage[] = [
  ...
  page('notification-outbox', 'Configuration / Notifications', 'Email Outbox', 'Review queued, sent, and failed email delivery records.'),
  page('ai-settings', 'Configuration', 'AI Settings', 'Review AI runtime, agents, and guardrails.'),
  page('integrations', 'Configuration', 'Integrations', 'Connect external services used by recruiting workflows.'),
